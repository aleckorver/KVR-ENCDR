...
//Markers to determine outgoing message type
// Type      Byte6[7] Byte6[6]
//Alpha         0         0
//Alpha Beta    0         1
//X Y Z         1         0
//non regular   1         1
...
//Diagnostic status
// Type            Byte1[7] Byte1[6]
//1st unfinished      0        0
//diag fail           0        1
//diag pass (prev)    1        0
//diag pass (new)     1        1

//Message with KEY contains Key echo on Byte 3 and byte 2
//Byte6[7] Byte6[6] Byte6[5] Byte6[4] Byte6[3] Byte6[2] Byte6[1] Byte6[0]
//   1         1       0        1        0        0        0        1

//Message with OscCounter contains counter value on byte 3 and byte 2
//Byte6[7] Byte6[6] Byte6[5] Byte6[4] Byte6[3] Byte6[2] Byte6[1] Byte6[0]
//   1         1       0        1        1        0        1        1

//AFTER POWER ON FIRST MESSAGE IS A READY MESSAGE
//Byte6[7] Byte6[6] Byte6[5] Byte6[4] Byte6[3] Byte6[2] Byte6[1] Byte6[0]
//   1         1       1        0        1        1        0        0

//ERROR MESSAGE CONTAINED ON BYTE 0
//Byte6[7] Byte6[6] Byte6[5] Byte6[4] Byte6[3] Byte6[2] Byte6[1] Byte6[0]
//   1         1       1        1        1        1        0        1
//Byte 0 Code    ERR TYPE
//        1     Incorrect BitCount
//        2     Incorrect CRC
//        3     Answer = NTT Message
//        4     OPCODE not valid
      
//FAILSAFE MODE - FSMERC on Byte3[7] Byte3[6]
//Byte6[7] Byte6[6] Byte6[5] Byte6[4] Byte6[3] Byte6[2] Byte6[1] Byte6[0]
//   1         1       0        1        0        1        1        1

//Truth table
//Byte6[7] Byte6[6] Byte6[5] Byte6[4] Byte6[3] Byte6[2] Byte6[1] Byte6[0] 
//   1         1       0        1        0        1        1        1           FAILSAFE MODE DEC 215
//   1         1       1        1        1        1        0        1           ERROR MESSAGE DEC 253
//   1         1       1        0        1        1        0        0           FIRST POWER ON READY MESSAGE DEC 236
//   1         1       0        1        1        0        1        1           OSC COUNTER MESSAGE DEC 219
//   1         1       0        1        0        0        0        1           KEY MESSAGE DEC 209
//   1         1       1        1        1        1        1        0           NOTHING TO TRANSMIT (NTT) DEC 254
//   1         1       0        1        0        1        1        1           Diagnostic Details DEC 215
//   1         1       0        0        0        1        0        0           EEWRITE CHALLENGE KEY DEC 196
//   1         1       0        1        1        0        0        0           EEREAD ANSWER DEC 216
//   1         1       0        0        1        1        1        0           EESWRITE STATUS DEC 206
//   1         1       1        0        1        1        1        1           REBOOT DEC 239
//   1         1       1        1        0        0        0        1           STANDBY DEC 241
//   0         0       -        -        -        -        -        -           Alpha Message DEC <= 63
//   0         1       -        -        -        -        -        -           Alpha Beta Message DEC <= 127 && DEC >= 64
//   1         0       -        -        -        -        -        -           X Y Z Message DEC <= 191 && DEC >= 128


#define keyMsg 209
#define oscCounterMsg 219
#define pwrOnMsg 236
#define errMsg 253
#define failSafeMsg 215
...
uint8_t MELEXIS::get_footer(){
  return inbuffer[6];
}

uint8_t MELEXIS::get_diag_details1(){
  return inbuffer[2];
}

uint8_t MELEXIS::get_diag_details2(){
  return inbuffer[3];
}
...
uint8_t MELEXIS::poll(bool cyberT)
{
  ...
  outbuffer[3] = 0xFF;
  if(cyberT == true){
    outbuffer[6] = 0x40 | MELEXIS_GET1;  // for alpha + beta 
  }
  else{
    outbuffer[6] = 0x80 | MELEXIS_GET1;  // for X + Y + Z  
  }
  return do_SPI();
}
